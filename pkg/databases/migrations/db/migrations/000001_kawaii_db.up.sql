...
-- docker run --name kawali_db_test -e POSTGRES_USER=admin -e POSTGRES_PASSWORD=1234 -p 4444:5432 -d eb634efa7ee4668e7bb7a9afa946987699608e5cff79418d39e7c5302f6ea3e8
-- migrate -source file:///Users/nick__napat/Desktop/learning/goLange/project-e-commerce/pkg/databases/migrations/db/migrations -database 'postgres://admin:1234@localhost:4444/admin?sslmode=disable' -verbose up 